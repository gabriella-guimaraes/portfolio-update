...
const project = [
    {
        ...
        img: "/images/movie-browser-snippet.png"
    },
    {
        id: 2,
        ...
        img: "/images/should_I_watch_snapshoot.png"
    },
    {
        id: 3,
        ...
        img: "/images/livreiro_snapshoot.png"
    },
    {
        id: 4,
        title: "Games API",
        ...
        img: "/images/API_default_snippet.png"
    }
]
            ...
            {project.map((info) => (
                <Grid size={10} key={info.id}>
                        <FadeInSection animationType='up'>
                            <ProjectCard image={info.img} title={info.title} description={info.description} badge={info.badge} />
                        </FadeInSection>
                    </Grid>
            ))}
        </Grid>
